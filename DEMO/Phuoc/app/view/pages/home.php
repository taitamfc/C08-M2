            ...
            <?php foreach ($params['notes'] as $key => $note) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $note->id ?>">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Bạn có chắc chắn muốn xóa : <?= $note->title ?></h5>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn mb-2 mb-md-0 btn-primary btn-sm btn-round mr-3" data-bs-dismiss="modal">Close</button>
                                        <a href="index.php?controller=Home&action=delete&note_id=<?= $note->id ?>" class="btn mb-2 mb-md-0 btn-danger btn-sm btn-round mr-3">Save changes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ul>
                    <li>
                        <?php if ($params['page'] > 1) : ?>
                            <a href="index.php?controller=Home&action=index&page=<?= $params['page'] - 1 ?>">&lt;</a>
                        <?php else : ?>
                            <span>&lt;</span>
                        <?php endif; ?>
                    </li>
                    <?php for ($i = 1; $i <= $params['pages']; $i++) : ?>
                        <li><a href="index.php?controller=Home&action=index&page=<?= $i ?>"><?= $i ?></a></li>
                    <?php endfor; ?>
                    <li>
